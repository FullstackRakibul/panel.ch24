    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden flex flex-col lg:flex-row w-full max-w-6xl">
      ...
      <div class="hidden lg:flex lg:w-1/2 p-8 items-center justify-center bg-gradient-to-br  relative">
        <div class="text-center space-y-4">
          <h2 class="text-4xl font-extrabold text-gray-900 leading-tight font-sans">
            Welcome back!
          </h2>
          <p class="text-lg text-gray-700 max-w-sm mx-auto font-sans">
          ...
          <img src="https://rsssc.org/assest/img/Login.jpg" alt="Illustration"
            class="mt-8 max-w-xl mx-auto rounded-lg " />
        </div>
      </div>
      ...
      <div class="w-full lg:w-1/2 p-8 sm:p-12 flex flex-col justify-center">
        <div class="max-w-md mx-auto w-full space-y-8">
          <div>
            ...
            <p class="mt-2 font-bold text-center text-lg text-gray-600 font-sans ">System Dashboard
            </p>
          </div>
          ...
          <el-form ref="loginFormRef" :model="form" :rules="rules" class="space-y-6">
            <el-form-item prop="email">
              <el-input v-model="form.email" placeholder="Email address" :prefix-icon="MessageSquare" size="large"
                class="rounded-lg" />
            </el-form-item>
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            <el-button size="large"
              class="w-full flex items-center justify-center rounded-lg border border-gray-300 shadow-sm hover:bg-gray-50">
              <img
            ...
            <el-button size="large"
              class="w-full flex items-center justify-center rounded-lg border border-gray-300 shadow-sm hover:bg-gray-50">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjvzC_QRv6moAhgNb5C6e3yicKgFND1g2RwA&s"
