import { getAllAgenciesInfoService } from "@/services/Agencies/agencies.services"
...
const allAgenciesData = await getAllAgenciesInfoService()
...
export const useAgenciesStore = defineStore("agencies", () => {
  ...
  const getAllAgencies = () => {
    allAgencies.value = allAgenciesData.data.data
  }
